...
public class DemoTester {
    ...
    public static void main(String[] args) {
         ...
         */
        properties.put("STORE_PATH", "E:\\AliTianchi");
...
//                    DefaultBytesMessage m1 = (DefaultBytesMessage) messagesForQueue1.get(queue1Offset++);
//                    DefaultBytesMessage m2 = (DefaultBytesMessage) message;
//                    String s1 = new String(m1.getBody());
//                    String s2 = new String(m2.getBody());
//                    if (!s1.equals(s2)) {
